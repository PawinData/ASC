...
$\therefore \mu(\frac{X+Y}{2}) = \frac{\mu_X + \mu_Y}{2} = 0, \; \sigma^2(\frac{X+Y}{2}) = \frac{\sigma^2_X + \sigma^2_Y}{2^2} = 0.25$

$\therefore U = \frac{X+Y}{2} \sim N(0,0.25)$

$\therefore \mathcal{p}_U(t) = \frac{1}{\sqrt{0.5 \pi}} \cdot \exp[-2 t^2]$

Meanwhile,

$\mathcal{p}_V(t) = \mathcal{p}_X + \mathcal{p}_Y = \frac{1}{\sqrt{2\pi}} \cdot (\exp[-\frac{(t - 1)^2}{2}] + \exp[-\frac{(t + 1)^2}{2}])$
...
**The distribution of $V$ is bimodal while $U$ still obeys to a normal distribution.**
...
**$U$ follows a squeezed normal distribution N(0,0.25).**